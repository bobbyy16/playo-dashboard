      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="">
            ...
            <th className="px-4 py-2 text-start">Payment Mode</th>
            <th className="px-4 py-2 text-start">
              <FaSort className="inline-block mr-1 text-start" />
              Status
            </th>
        ...
        <tbody>
          {dataArray.map((customerData, index) => (
            ...
            >
              ...
              <td className="border-gray-300 px-2 py-2 flex items-center justify-start text-black text-start">
                {customerData.img && (
                  <img
                    src={customerData.img}
                    width={25}
                    height={25}
                    className="mr-2 rounded-lg text-start"
                    alt="Product"
                  />
                )}
              ...
              <td className="border-gray-300 px-2 py-2 text-black-500 text-start">
              ...
              <td className="border-gray-300 px-2 py-2 text-start text-black-500">
                <span
